...
import { ShieldCheck, ChevronRight, CheckCircle2, ArrowRight, Phone, X } from 'lucide-react';
        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div
              ...
              className="relative aspect-square md:aspect-[4/5] rounded-3xl overflow-hidden border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] group cursor-pointer"
            >
              <div className="absolute inset-0 bg-cyan/20 blur-[80px] -z-10 rounded-full mix-blend-screen" />
              <img 
                src={serviceData.image} 
                alt={serviceData.title} 
                className={`w-full h-full object-cover ${serviceData.imagePosition || 'object-center'} group-hover:scale-105 transition-transform duration-1000`}
              />
      ...
      <AnimatePresence>
        {isLightboxOpen && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[100] flex items-center justify-center bg-navy/95 backdrop-blur-md p-4 sm:p-12"
