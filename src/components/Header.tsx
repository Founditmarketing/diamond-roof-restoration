  ...
  right: [
    {
      ...
      dropdown: [
        ...
        { name: 'Claxton, GA', link: '/service-areas/claxton-ga' },
        { name: 'Douglas, GA', link: '/service-areas/douglas-ga' },
        ...
        { name: 'Kingsland, GA', link: '/service-areas/kingsland-ga' },
        { name: 'Pooler, GA', link: '/service-areas/pooler-ga' },
        { name: 'Saint Marys, GA', link: '/service-areas/saint-marys-ga' },
        { name: 'Savannah, GA', link: '/service-areas/savannah-ga' },
        { name: 'St. Simons Island, GA', link: '/service-areas/st-simons-island-ga' },
        { name: 'Statesboro, GA', link: '/service-areas/statesboro-ga' },
        { name: 'Vidalia, GA', link: '/service-areas/vidalia-ga' },
        { name: 'Waycross, GA', link: '/service-areas/waycross-ga' }
      ]
    },
    {
      name: 'About',
