...
const services = [
  ...
  },
  {
    ...
    link: '/services/metal-roof-installation'
  },
  {
    ...
    link: '/services/asphalt-shingle-roof-installation'
  },
  {
    ...
    link: '/services/membrane-roofing-installation'
  },
];
    ...
    <section id="services" className="py-24 bg-navy relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="mb-16 md:flex md:items-end md:justify-between gap-8">
          ...
          <Link to="/services/roofing-contractor" className="hidden md:flex items-center gap-2 text-cyan font-bold uppercase tracking-widest text-[12px] hover:text-white transition-colors mt-6 md:mt-0">
        ...
        <Link to="/services/roofing-contractor" className="md:hidden w-full flex items-center justify-center gap-2 text-cyan font-bold uppercase tracking-widest text-[12px] hover:text-white transition-colors mt-10 border border-cyan/30 py-4 rounded">
          View All Systems <ArrowRight className="w-4 h-4" />
        </Link>
      </div>
    </section>
